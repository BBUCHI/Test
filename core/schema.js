...
export const FORM_SPEC = {
  ...
  events: [
    { key:'photo', label:'Photo', kind:'image', hint:"URL d'une image. Laissez vide pour ne rien afficher." },
    { key:'tags', label:'Tags', kind:'tags' },
    { key:'titres_honorifiques', label:'Titres honorifiques', kind:'tags', hint:"Titres, épithètes ou surnoms honorifiques attribués à cette fiche." },
  ...
  personnages: [
    { key:'attributs.photo', label:'Photo', kind:'image', hint:"URL d'une image (portrait). Laissez vide pour ne rien afficher." },
    { key:'attributs.tags', label:'Tags', kind:'tags' },
    { key:'attributs.titres_honorifiques', label:'Titres honorifiques', kind:'tags', hint:"Titres, épithètes ou surnoms honorifiques attribués à cette fiche." },
    ...
    { key:'attributs.formes', label:'Formes', kind:'personnage-formes', hint:"Les formes que ce personnage peut prendre (métamorphose, avatars…)." },
    { key:'timeline', label:'Existence', kind:'timeline', hint:'Vie / mort. Plusieurs périodes = résurrection.' },
    { key:'alignements', label:'Alignement(s)', kind:'alignements' },
    { key:'roles', label:'Rôles & position', kind:'roles', hint:"La position/résidence peut être ajoutée ici comme un rôle générique (ex. « résidence »)." },
    ...
    { key:'description', label:'Description', kind:'description', fields:[
      ...
      ['relations','Relations (narratif)'],['equipement','Équipement (narratif)']
    ]},
    { key:'attributs.anecdotes', label:'Anecdotes', kind:'narrative-list' },
  ],
  lieux: [
    { key:'attributs.photo', label:'Photo', kind:'image', hint:"URL d'une image. Laissez vide pour ne rien afficher." },
    { key:'attributs.tags', label:'Tags', kind:'tags' },
    { key:'attributs.titres_honorifiques', label:'Titres honorifiques', kind:'tags', hint:"Titres, épithètes ou surnoms honorifiques attribués à cette fiche." },
    ...
    { key:'altitude', label:'Altitude(s)', kind:'int-list', min:0, max:6, compact:true },
    { key:'situe_dans', label:'Situé dans (si sous-lieu)', kind:'ref', sources:['lieux'], nullable:true, hint:"Uniquement pour un sous-lieu — altitude et régions sont alors hérités du lieu englobant." },
    ...
    { key:'habitants', label:'Habitants (calculé)', kind:'habitants', hint:"Pertinent surtout pour ville/village. Recalculé depuis les rôles des personnages." },
    { key:'attributs.anecdotes', label:'Anecdotes', kind:'narrative-list' },
  ],
  groupes: [
    { key:'attributs.photo', label:'Photo', kind:'image', hint:"URL d'une image. Laissez vide pour ne rien afficher." },
    ...
    { key:'description', label:'Description', kind:'description', fields:[
      ...
      ['membres_notables','Membres notables (narratif)'],['mode_recrutement','Mode de recrutement'],
      ['territoire_lieu_rassemblement','Territoire / lieu de rassemblement (narratif)'],['influence','Influence'],
